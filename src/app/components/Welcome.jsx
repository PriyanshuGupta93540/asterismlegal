...
const Welcome = () => {
  return (
     <div className='mt-96 ml-72 relative'>

    <div className='w-80 h-36 '>
      <img src="images/9.jpg" alt="" className='h-97 w-80 shadow-2xl rounded-md'/>
    </div>
    <div className='ml-96 absolute top-12'>
      <div className='w-72'>
        <h1 className='text-3xl mb-4 font-bold text-dark w-96'>WELCOME TO THE ASTERAL LAW FIRM</h1>
      </div>
      <div className='w-60 '>
        <hr className='border-yellow-500 border mt-3 mb-3'/>
      </div>
      <div className='w-97'>
        <p className='text-sm'>Asterisms Legal (AL) is full-service law firm. AL was founded with the sole motive of helping, assisting and guiding the clients in achieving prompt legal solutions by way of holistic and pragmatic approach & to .</p>
      </div>
