...
const Contactform = () => {
  ...
  return (
    <div className='mt-36 flex ml-44 contact-container'>
        ...
        <div className='ml-32 w-99 pl-12 h-120 contact shadow-2xl rounded-lg contact-form'>
            <h1 className='ml- mb-10 mt-8 font-bold text-3xl text-slate-600'>CONTACT US </h1>
            <div className=' w-24 '>
                <div className='flex contact-name'>
                   <input type="text" placeholder='Your Name' className='mr-4 w-48 pl-4 h-10 border contact-email'/>
              
                   <input type="text" name="" id="" placeholder='Phone Number' className='w-48 h-10 pl-4 text-slate-600 border contact-number'/>
                </div>
                <input type="text" placeholder='E-mail Address' className='mt-8 w-96 h-10 pl-4 border contact-phone'/>
                <br/>
                   <br/>
                <input type="text" placeholder='Message' className=' mt-3 w-96 h-10 pl-4 border contact-message'/>
            </div>
            <div className='mt-10 w-28 h-10 pl-4 pt-2 bg-yellow-500 contact-submit text-white'>
                Submit
            </div>
        </div>
        </div>
