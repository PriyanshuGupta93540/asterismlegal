...
const Contact = () => {
  return (
    <>
      <section className="bg-white py-20 lg:py-[120px] overflow-hidden contactus-div z-10 mt-16 relative">
        <div className="container">
          <div className="flex flex-wrap lg:justify-between">
            <div className="w-full pl-36 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[400px] lg:mb-0 ">
                <span className="block mb-4 text-base font-semibold text-primary text-yellow-500 font-serif">
                  Contact Us
                </span>
                <h2 className="mb-6 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px] ">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base leading-relaxed mb-9 text-body-color text-slate-900">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color text-slate-800">
            ...
            <div className="w-96 px-4 lg:w-1/2 xl:w-5/12 absolute left-103 contactus-right">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12 border-4">
                <div className="mb-4">
                    <h1 className="text-yellow-500 font-serif">YOU WILL HEAR FROM US SHORTLY....</h1>
                </div>
                <form>
                  <ContactInputBox
                    type="text"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white bg-yellow-400 transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
